...
- **Registries**: `.claude/project/` (e.g., `workspace_map.md`, `baseline_registry.md`, `experiment_registry.md`)
- **Sibling Repos**: `fedmaq-literature`, `fedmaq-analyses`, `fedmaq-manuscript`, `fedmaq-presentations` — see [.claude/project/workspace_map.md](.claude/project/workspace_map.md) for the workspace map.
