...
4. Verify that the client delay simulation in [client.py](../../src/fedmaq/core/client.py) and server distillation delay in [strategy.py](../../src/fedmaq/core/strategy.py) match the mathematical formulations defined in the manuscript.
