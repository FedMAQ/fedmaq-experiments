...
2. Read active rules and constraints in [.claude/rules/](../../rules/).
3. Validate and synchronize parameters in [default.yaml](../../../conf/experiment/default.yaml) and [preliminary.yaml](../../../conf/experiment/preliminary.yaml).
...
5. Check that precision-scaling allocations inside the strategy hooks match the soft quality targets.
