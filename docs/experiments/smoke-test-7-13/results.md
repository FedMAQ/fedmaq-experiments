...
| :------------------------------- | :-----------: | :--------: | :------------------: | :-----------------------: | :-------------: |
| **FedMAQ-Lite** (Tuned, Ours)    |  **52.83%**   | **1.3629** |    **3967.4 MB**     |    **8.6x reduction**     |     3487.3s     |
| **FedProx**                      |    49.71%     |   1.6441   |      34100.2 MB      |           1.0x            |     5554.0s     |
| **DAdaQuant**                    |    41.49%     |   2.0600   |      18531.4 MB      |           1.8x            |     4122.6s     |
| **FedMAQ-Lite** (Original, Ours) |    38.76%     |   1.6788   |    **3534.6 MB**     |    **9.6x reduction**     |   **3423.9s**   |
...
| **FedMAQ-Lite** (Tuned, Ours)    |  **63.28%**   | **1.0815** |    **4072.1 MB**     |    **8.4x reduction**     |     2310.5s     |
| **FedMAQ-Lite** (Original, Ours) |    58.07%     |   1.1902   |    **3864.8 MB**     |    **8.8x reduction**     |   **2295.6s**   |
